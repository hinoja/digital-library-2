                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-6">
                    <div class="logo my-2 my-sm-0">
                        <a href="{{ route('welcome') }}">
                            <img src="{{ asset('assets/img/BERTOUA.png')}}" alt="logo image" width="80px" height="110px">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="user-block d-none d-lg-block">
                        <div class="row align-items-center">
                            <div class=" col-7 text-center align-center">
                                <h2 class="text-center titre-app align-center">Bibliothèque Numérique <br> de l'ENS de BERTOUA</h2>
                            </div>
                            <div class="col-lg-5 col-md-12 col-sm-12">
                                <div class="user-notification-block align-right d-inline-block">
                                    <div class="top-nav-search">
                                        <form>
                                            <input type="search" autocomplete id="searchbar-welcome" class="form-control"
                                                placeholder="Rechercher ici..">
                                            <button class="btn" type="submit"><i  style="color:blue;"
                                    ...
                                    <a href="javascript:void(0)" data-toggle="dropdown"
                                        ...
                                        <div class="user-avatar d-inline-block">
                                            <img src="{{ auth()->user()->avatar ? Storage::url(auth()->user()->avatar) : asset('assets/img/profiles/user-default.png') }}" alt="user avatar"
                                                class="rounded img-fluid" style="color:blue" width="60">
                                        </div>
                                    </a>
                            ...
                            @else
                                <div class="user-info align-right dropdown d-inline-block header-dropdown">
                                    <a href="javascript:void(0)" data-toggle="dropdown"
                                        class=" menu-style dropdown-toggle">
                                        <div class="user-avatar d-inline-block">
                                            <img src="{{ asset('assets/img/profiles/login2.png')}}" alt="user avatar"
                                                class="rounded img-fluid" style="color:blue" width="60">
                                        </div>
                                    </a>
                                    ...
                                    <div
                                        ...
                                        {{-- <a class="dropdown-item p-2" href="settings.html">
                                            <span class="media align-items-center">
                                                ...
                                                <li>
                                                    <a href="{{ route('login') }}"
                                                    class="dropdown-item"> @lang('CONNEXION')
                                                    </a>
                                                </li>
                                            {{-- <span class="media align-items-center">
